...
NN.prototype.toJson = function () {
    var toSave = {
        ...
        inputLayerSetup: this.inputLayerSetup,
        outputs: this.outputs,
        netInput: this.netInput,
        errorSigs: this.errorSigs
    }
...
NN.prototype.fromJson = function (jsonStr) {
    ...
    this.errorSigs = parsed.errorSigs
    this.outputs = parsed.outputs
    this.netInput = parsed.netInput
    this.changes = parsed.changes
    this.inputLayerSetup = parsed.inputLayerSetup
